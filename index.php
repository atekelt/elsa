  ...
  <body>
    <div class="py-1 bg-black top">
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Elsa Bar And Restaurant</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item cta"><a href="reservation.html" class="nav-link">Book a room</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="tel" class="form-control" name="phone" placeholder="251-000-000-000" pattern="[0-9]{3}-[0-9]{3}-[0-9]{3}-[0-9]{3}" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="">Date Of Arrival</label>
                    <input type="text" class="form-control" id="book_date" placeholder="Date" name="date_of_arrival" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="">Time Of Arrival</label>
                    <input type="text" class="form-control" id="book_time" name="time_of_arrival" placeholder="Time" required>
                  </div>
                </div>
				<div class="col-md-6">
                  <div class="form-group">
      ...
      <div class="container-fluid px-md-5 px-3">
        <div class="row mb-5">
          <div class="col-md-6 col-lg-3">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Elsa</h2>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This Website is designed by Kitab Design Solutions.
  </p>
          </div>
        </div>
      </div>
